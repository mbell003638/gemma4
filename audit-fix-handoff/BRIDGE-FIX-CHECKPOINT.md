...
Native now emits matching acknowledgements through the serial production coordinator.
The protocol was reconciled by source inspection only. No new acceptance claim
follows from historical test counts.
