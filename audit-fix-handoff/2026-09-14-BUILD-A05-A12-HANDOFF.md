# A05/A12 build handoff — codex — 2026-09-14
...
Scope: [gemma4-lab](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab>) on local branch `codex/gemma4-p0-p3`, read at assignment start. Existing dirty changes and other owners' scopes preserved. No remote branch existence is claimed.
...
$buildArgs = @{
    ...
    BaselineApk = 'C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/artifacts/android/codex-gemma-arm64-debug.apk'
}
& 'C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/build-standalone.ps1' @buildArgs
```
...
```powershell
python -B 'C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/test-standalone-apk.py'
```

Reinspect a newly produced artifact separately, only after verification is authorized:

```powershell
python -B 'C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/verify-standalone-apk.py' --apk '<new Gemma standalone APK>' --runtime gemma --package com.ahem.ledgrai.codexsol --min-sdk 24 --target-sdk 36 --baseline-apk 'C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/artifacts/android/codex-gemma-arm64-debug.apk' --zipalign '<installed zipalign.exe>' --aapt2 '<installed aapt2.exe>'
```
...
- [.github/workflows/android-native-validation.yml](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/.github/workflows/android-native-validation.yml>)
- [.github/workflows/build-apk.yml](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/.github/workflows/build-apk.yml>)
- [.github/workflows/gemma-standalone.yml](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/.github/workflows/gemma-standalone.yml>)
- [frontend/modules/ledgr-native-ai/android/build.gradle](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/modules/ledgr-native-ai/android/build.gradle>)
- [frontend/modules/ledgr-native-ai/android/src/main/cpp/CMakeLists.txt](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/modules/ledgr-native-ai/android/src/main/cpp/CMakeLists.txt>)
- [frontend/scripts/on-device-ai/audit-testsigning.init.gradle](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/audit-testsigning.init.gradle>)
- [frontend/scripts/on-device-ai/build-standalone.ps1](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/build-standalone.ps1>)
- [frontend/scripts/on-device-ai/verify-standalone-apk.py](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/verify-standalone-apk.py>)
- [frontend/scripts/on-device-ai/test-standalone-apk.py](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/frontend/scripts/on-device-ai/test-standalone-apk.py>)
- [audit-fix-handoff/BUILD-FIX-CHECKPOINT.md](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/audit-fix-handoff/BUILD-FIX-CHECKPOINT.md>)
- [audit-fix-handoff/2026-09-14-BUILD-A05-A12-HANDOFF.md](<C:/Users/just2/Downloads/Ledger AI Codex/gemma4-lab/audit-fix-handoff/2026-09-14-BUILD-A05-A12-HANDOFF.md>)
